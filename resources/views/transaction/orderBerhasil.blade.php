            ...
            <div class="formContainer mt-2 mb-5">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col justify-content-center" align="center">
                        <h1 class="card-head text-white" style="margin:5px auto">Order Berhasil</h1>
                        <div class="card text-start card-resi w-50 mt-2 mb-2 p-2">

                            <h6 class="card-head-resi">Nomor Resi : {{ $orders[0]->no_resi }} (Mohon di Ingat)</h6>
                        ...
                        <button type="button" class="btn btn-primary mt-2"><a href="/"
                                style="text-decoration: none; color:aliceblue">Oke</a></button>
                    </div>
                </div>
            </div>
        </div>
