                    ...
                    <div class="row justify-content-center p-2">
                        ...
                        <div class="col mt-2 mb-2" id="order" hidden>
                            ...
                            <div class="row p-1" style="margin-left:1rem;margin-right:1rem">
                                ...
                                <label><input type="radio" id="deliveryBy" name="deliveryBy" value="Kurir">Kurir (Ongkir ditanggung sendiri)</label>
                                <label><input type="radio" id="deliveryBy" name="deliveryBy" value="Sendiri">Sendiri</label>
                            </div>
                            <div class="row p-1" style="margin-left:1rem;margin-right:1rem">
                                <label>Pick Up By</label>
                                <label><input type="radio" id="pickupBy" name="pickupBy" value="Kurir">Kurir (Ongkir ditanggung sendiri)</label>
                                <label><input type="radio" id="pickupBy" name="pickupBy" value="Sendiri">Sendiri</label>
                            </div>
                            <div class="row mt-3 justify-content-center">
                        ...
                        <div class="col mt-2 mb-2" id="payment" hidden>
                            ...
                            <div class="row p-1 d-block" style="margin-left:1rem;margin-right:1rem">
                                ...
                                <!-- <span id="hargaTotal" hidden>{{ $biaya }}</span>
