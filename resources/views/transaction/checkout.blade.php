                        ...
                        <div class="row justify-content-center p-2">
                            <div class="col mt-2 mb-2" id="identity">
                                ...
                                <div class="row p-1" style="margin-left:1rem;margin-right:1rem">
                                    ...
                                    <input type="text" id="noHP" name="noHP" value="{{ auth()->user() ? auth()->user()->no_hp : '' }}">
                                </div>
                            ...
                            <div class="col mt-2 mb-2" id="payment" hidden>
                                ...
                                <div class="row mt-3 justify-content-center">
                                    ...
                                    <button type="submit" class="btn btn-primary m-2" style="width:fit-content"
                                        >Submit</button>
                                </div>
                            </div>
                        </div>
