                    ...
                    <div class="col justify-content-center" align="center">
                        <div class="card text-start card-resi w-50 mt-2 mb-2 p-2">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="card-desc-text">Estimasi Selesai</td>
                                    @if ($estimasiWaktu == '-')
                                        <td class="card-desc-text">: {{ $estimasiWaktu }}</td>
                                    @else
                                        <td class="card-desc-text">: {{ date('d-m-Y', strtotime($estimasiWaktu)) }}</td>
                                    @endif
                        ...
                        <div class="card text-start card-resi w-50 mt-2 mb-2 p-2">
                            ...
                            <ul>
                                ...
                                @foreach ($statusLogs as $statusLog)
                                    <li>
                                        <p class="card-desc-text"><span
                                                style="font-weight:bold">{{ date('d-m-Y', strtotime($statusLog->created_at)) }}</span>
                                            : {{ $statusLog->status }}</p>
                                    </li>
                                @endforeach
                            </ul>
