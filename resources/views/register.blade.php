        ...
        <div class="formContainer">
            ...
            <form action="/register" method="POST">
                ...
                <div class="row d-flex">
                    <div class="my-2">
                        <span class="inputLogo"></span><input type="email"
                            class="form-control rounded-pill @error('email') is-invalid @enderror" name="email"
                            placeholder="Insert Your Email" value="{{ old('email') }}">
                        @error('email')
                    ...
                    <div class="my-2">
                        <span class="inputLogo"></span><input type="text"
                            ...
                            placeholder="Insert Your Name" value="{{ old('name') }}">
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="my-2">
                        <span class="inputLogo"></span><input type="tel"
                            ...
                            placeholder="Insert Your Phone Number" value="{{ old('no_hp') }}">
                        @error('no_hp')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col">
                            ...
                            <div class="col">
                                <div class="my-2">
                                    <span class="inputLogo"></span><input type="text"
                                        ...
                                        name="negara" placeholder="Insert Your Country" value="{{ old('negara') }}">
                                    @error('negara')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col">
                                <div class="my-2">
                                    <span class="inputLogo"></span><input type="text"
                                        ...
                                        name="kota" placeholder="Insert Your City" value="{{ old('kota') }}">
                                    @error('kota')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="my-2">
                                    <span class="inputLogo"></span><input type="text"
                                        class="form-control rounded-pill @error('kelurahan') is-invalid @enderror" name="kelurahan"
                                        placeholder="Insert Your Kelurahan" value="{{ old('kelurahan') }}">
                                    @error('kelurahan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="my-2">
                                    <span class="inputLogo"></span><input type="text"
                                        ...
                                        placeholder="Insert Your Address" value="{{ old('alamat') }}">
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col">
                                <div class="my-2">
                                    <span class="inputLogo"></span><input type="text"
                                        class="form-control rounded-pill @error('kode_pos') is-invalid @enderror" name="kode_pos"
                                        placeholder="Insert Your Post Code" value="{{ old('kode_pos') }}">
                                    @error('kode_pos')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="my-2">
                        <span class="inputLogo"></span><input type="password" class="form-control rounded-pill @error('kode_pos') is-invalid @enderror" 
