...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repHead" id="radio1" value="refinish_head" onchange="showDetails1(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repTuningMachine" id="radio3" value="refinish_tuning_machine" onchange="showDetails2(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repNut" id="radio5" value="refinish_nut" onchange="showDetails3(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repNeck" id="radio7" value="refinish_neck" onchange="showDetails4(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repFret" id="radio9" value="refinish_fret" onchange="showDetails5(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repPickup" id="radio11" value="refinish_pickup" onchange="showDetails6(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repBody" id="radio13" value="refinish_body" onchange="showDetails7(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repSaddle" id="radio15" value="refinish_saddle" onchange="showDetails8(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repBridge" id="radio17" value="refinish_bridge" onchange="showDetails9(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repPin" id="radio19" value="refinish_pin" onchange="showDetails10(this)">
    ...
    <div class="row align-items-center justify-content-center mt-3">
        <form action="/checkout" method="POST">
            ...
            <div class="row mt-3 d-flex justify-content-center">
                <div class="col d-flex justify-content-end">
                    <button type="button" class="btn btn-secondary" style="width:6rem" onClick="window.location.reload(true)">Reset Order</button>
                </div>
                <div class="col d-flex justify-content-start">
                    <button type="submit" class="btn btn-primary" style="width:6rem" data-toggle="button" aria-pressed="false" autocomplete="off" style="width:fit-content">Konfirmasi Pesanan</button>
                </div>
