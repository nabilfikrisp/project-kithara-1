...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repNeck" id="radio1" value="option1" onchange="showDetails1(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repFret" id="radio3" value="option1" onchange="showDetails2(this)">
...
<div class="form-check mt-1">
    <input class="form-check-input" type="radio" name="repPickup" id="radio5" value="option1" onchange="showDetails3(this)">
