...
@section('jenis_reparasi_body')
    ...
    <div class="form-check mt-1">
        <input class="form-check-input" type="radio" name="repBody" id="radio1" value="refinish_body"
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="radio" name="repBody" id="radio2" value="ubah_body">
...
@section('jenis_reparasi_saddle')
    ...
    <div class="form-check mt-1">
        <input class="form-check-input" type="radio" name="repSaddle" id="radio3" value="refinish_saddle"
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="radio" name="repSaddle" id="radio4" value="ubah_saddle">
...
@section('jenis_reparasi_bridge')
    ...
    <div class="form-check mt-1">
        <input class="form-check-input" type="radio" name="repBridge" id="radio5" value="refinish_bridge"
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="radio" name="repBridge" id="radio6" value="ubah_bridge">
...
@section('jenis_reparasi_pin')
    ...
    <div class="form-check mt-1">
        <input class="form-check-input" type="radio" name="repPin" id="radio7" value="refinish_pin"
    ...
    <div class="form-check mt-2">
        <input class="form-check-input" type="radio" name="repPin" id="radio8" value="ubah_pin">
...
@section('content')
    ...
    <div class="container-fluid mt-4 mb-4">
        ...
        <div class="row align-items-center justify-content-center mt-3">
            <form method="POST" action="/checkout-body" >
                @csrf
